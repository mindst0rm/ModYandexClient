(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5939],
    {
        ...
        38467: (e, t, o) => {
            'use strict';
            o.d(t, { LO: () => l, N5: () => n, vZ: () => a, toggleMiniPlayer: () => toggleMiniPlayer, showMergeModal: () => showMergeModal });
            var s = o(79169);
            let a = () => {
                var e;
                ...
                showMergeModal = () => {
                    var e;
                    null == (e = window.desktopEvents) || e.emit(s.EE.SHOW_MERGE_MODAL, Date.now());
                }
        },
        44312: (e, t, o) => {
            'use strict';
            ...
            let h = (e) => {
                ...
                toastWithProgress = (e) => {
                    let { closeToast: closeToast, toastID, message, buttonLabel, onButtonClick, disabled = false, dismissOnButtonClick = false } = e,
                        [getProgress, setProgress] = (0, a.useState)(-1),
                        [statusLabel, setStatusLabel] = (0, a.useState)('Ожидание...'),
            ...
            let r = (e) => {
                ...
                (0, s.useEffect)(() => {
                    let e,
                        ...
                        onVolumeChange = t?.state.playerState.exponentVolume?.onChange((e) => {
                            sendPlayerStateDefault(t);
                        }),
                        n =
                            null == t
            ...
            let _ = (e) => {
                ...
                h = (0, l.PA)((e) => {
                    let { withSecondaryColor: t } = e,
                        ...
                        onShowMergeModal = (0, n.useCallback)(() => {
                            (0, d.showMergeModal)();
                        }, []),
                        ...
                        children: (0, s.jsx)('div', {
                            ...
                            children: [
                                ...
                                (0, s.jsx)('div', {
                                    ...
                                    children: [
                                        (0, s.jsx)('span', { children: 'У проекта появился новый репозиторий!', style: { fontWeight: 'bold', fontSize: '18px', marginBottom: '10px', color: 'white', alignSelf: 'center' } }),
                                        (0, s.jsx)('span', { children: 'Разработка ModYandexClient продолжается, и обновления будут выходить регулярно.', style: { marginBottom: '10px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: 'Если вы не хотите ставить дополнительный софт, можете продолжать пользоваться клиентом как раньше.', style: { marginBottom: '5px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: 'Для полностью автоматического обновления при запуске можно использовать Launcher.', style: { marginBottom: '5px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: ['Launcher: ', (0, s.jsx)('a', { children: 'https://github.com/mindst0rm/yamusic-launcher', href: 'https://github.com/mindst0rm/yamusic-launcher', target:"_blank", rel:"noreferrer noopener", className: 'buOTZq_TKQOVyjMLrXvB MergeNoteModal_link' })], style: { marginBottom: '10px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: ['Репозиторий проекта: ', (0, s.jsx)('a', { children: 'https://github.com/mindst0rm/ModYandexClient', href: 'https://github.com/mindst0rm/ModYandexClient', target:"_blank", rel:"noreferrer noopener", className: 'buOTZq_TKQOVyjMLrXvB MergeNoteModal_link' })], style: { marginBottom: '10px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: 'Вы можете:', style: { fontWeight: 'bold', fontSize: '18px', marginBottom: '10px', color: 'white', alignSelf: 'center' }}),
                                        (0, s.jsx)('span', { children: 'Открыть новый репозиторий', style: { fontWeight: 'bold', fontSize: '18px', color: 'white', alignSelf: 'center' }}),
                                        (0, s.jsx)('span', { children: 'или', style: { alignSelf: 'center' }}),
                                        (0, s.jsx)('span', { children: 'Закрыть это сообщение', style: { fontWeight: 'bold', fontSize: '18px', color: 'white', alignSelf: 'center' }}),
                                        (0, s.jsx)('span', { children: 'Launcher можно установить позже, если захотите полностью автоматические обновления.', style: { marginBottom: '20px' }}),
                                        (0, s.jsx)('div', {
                                            ...
                                            children: [
                                                (0, s.jsx)('button', {
                                                    ...
                                                    children: [
                                                        (0, s.jsx)('span', { children: 'Продолжить без перехода',
                                                            style: {
                                                                alignSelf: 'center'
                                                            }
                                                        }),
                                                ...
                                                (0, s.jsx)('button', {
                                                    ...
                                                    children: [
                                                        (0, s.jsx)('span', { children: 'Открыть GitHub',
                                                            style: {
                                                                alignSelf: 'center'
                                                            }
                                                        }),

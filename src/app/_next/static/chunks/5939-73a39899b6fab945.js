                ...
                migrationModal = (0, l.PA)(() => {
                    ...
                    return (0, s.jsx)(d.a, {
                        ...
                        children: (0, s.jsx)('div', {
                            className: (0, a.$)(p().scrollableContent, p().important),
                            children: [
                                (0, s.jsx)('img', { alt: 'Обновления проекта',
                                    style: {
                                        display: 'block',
                                        width: '100%',
                                        borderRadius: '10px',
                                ...
                                (0, s.jsx)('div', {
                                    ...
                                    children: [
                                        (0, s.jsx)('span', { children: 'ModYandexClient продолжает развиваться', style: { fontWeight: 'bold', fontSize: '18px', marginBottom: '10px', color: 'white', alignSelf: 'center' } }),
                                        (0, s.jsx)('span', { children: 'Основные обновления теперь выходят в новом репозитории проекта.', style: { marginBottom: '10px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: 'Если вам удобно пользоваться текущим клиентом как раньше, ничего дополнительно устанавливать не нужно.', style: { marginBottom: '8px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: 'Launcher можно установить позже, если нужен быстрый автоапдейт при запуске.', style: { marginBottom: '8px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: ['Launcher: ', (0, s.jsx)('a', { children: 'yamusic-launcher', href: 'https://github.com/mindst0rm/yamusic-launcher', target:"_blank", rel:"noreferrer noopener", className: 'buOTZq_TKQOVyjMLrXvB MergeNoteModal_link' })], style: { marginBottom: '6px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: ['GitHub: ', (0, s.jsx)('a', { children: 'mindst0rm/ModYandexClient', href: 'https://github.com/mindst0rm/ModYandexClient', target:"_blank", rel:"noreferrer noopener", className: 'buOTZq_TKQOVyjMLrXvB MergeNoteModal_link' })], style: { marginBottom: '16px', color: 'white' }}),
                                        (0, s.jsx)('span', { children: 'Это окно можно просто закрыть и вернуться к музыке в любой момент.', style: { marginBottom: '20px', color: 'rgba(255,255,255,0.72)' }}),
                                        (0, s.jsx)('div', {
                                            ...
                                            children: [
                                                (0, s.jsx)('button', {
                                                    ...
                                                    children: [
                                                        (0, s.jsx)('span', { children: 'Остаться здесь',
                                                            style: {
                                                                alignSelf: 'center'
                                                            }
                                                        }),
                                                ...
                                                (0, s.jsx)('button', {
                                                    ...
                                                    children: [
                                                        (0, s.jsx)('span', { children: 'Открыть репозиторий',
                                                            style: {
                                                                alignSelf: 'center'
                                                            }
                                                        }),
